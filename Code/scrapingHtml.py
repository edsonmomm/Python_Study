...
# Python program similar to http://www.pythonlearn.com/code/urllink2.py. The program 
...
# Actual data: http://pr4e.dr-chuck.com/tsugi/mod/python-data/data/comments_170864.html (Sum ends with 74)
...
url = "http://pr4e.dr-chuck.com/tsugi/mod/python-data/data/comments_170864.html"
...
tags = soup('span')
for tag in tags:
    # Look at the contents to retrieve the numbers to sum
    sumComment = sumComment + int(tag.contents[0])
