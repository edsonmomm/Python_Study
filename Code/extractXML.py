# Welcome Edson Momm from Using Python to Access Web Data

# Extracting Data from XML

# In this assignment you will write a Python program somewhat similar to 
# http://www.pythonlearn.com/code/geoxml.py. The program will prompt for a URL, 
# read the XML data from that URL using urllib and then parse and extract the comment 
...
# Actual data: http://pr4e.dr-chuck.com/tsugi/mod/python-data/data/comments_170861.xml (Sum ends with 32)
...
# The closest sample code that shows how to parse XML is geoxml.py. But since the nesting of the 
...
url = "http://pr4e.dr-chuck.com/tsugi/mod/python-data/data/comments_170861.xml"
xml = urllib.urlopen(url).read()

#print xml
print "Receiving ", len(xml), "characters"
